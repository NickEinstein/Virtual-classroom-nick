...
import guardian from '../../public/images/banners/guardian.png';
...
export default function GuardianSignup() {
  ...
  function signup() {
    setLoading(true)
    axios.post('https://theclassroom.ci-auction.ng/api/v1/guardian/signup', details)
    .then(response => {
    ...
    <Layout>
      ...
      <section className="signup signup-single">
        ...
        <div  className="col-md-6 col-lg-6 col-xs-12">
          ...
          <div className="col-md-6 col-lg-6 col-xs-12 text-center">
            <div className="card">
              <div className="card-body">
                <div className="card-img">
                  <Image src={guardian} className="img-fluid" alt="guardian" />
                </div>
              </div>
            </div>
