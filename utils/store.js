...
const defaultState = {
    ...
    config: {
        uid: 88356484589383,
        appid: '8db1ac870b1e421f946935dfbacf05e4',
        host: true,
        channelName: 'TheClassroom',
        token: 'NETLESSSDK_YWs9ak84QnFRa2FBTGlQUXVQMCZub25jZT0wMWEzZGI1MC04NWM1LTExZWMtYjdjMi1lMTI1ZGY5ZDhkZTMmcm9sZT0wJnNpZz1hZDUwODQ2NGE5NDljNWQ4MDhmNmRkMzEwZjNkYzkxMTFjMjRmMWU4OWE3MTlmN2MxYjI0MDA5NmJiNGZjOGY5', //process.env.REACT_APP_AGORA_APP_TOKEN,
        resolution: '480p',
        ...readDefaultState(),
        microphoneId: '',
        cameraId: '',
...
const reducer = (state, action) => {
    switch (action.type) {
        ...
        case 'setRoom': {
            return {...state, boardRoom: action.payload}
        }
        case 'memberState': {
            return {...state, memberState: action.payload}
        }
        case 'currentStream': {
            const {streams} = state
